...
class Players(db.Model):
    Player_ID = db.Column(db.Interger, primary_key = True)
    Player_name = db.Column(db.String(255))
    Character_Name = db.Column(db.String(255))
    Character_Level = db.Column(db.Interger(2))
    Character_Class = db.Column(db.String(255))
    Character_Race = db.Column(db.String(255))
    Campaign = db.Column(db.Interger,  db.ForeignKeys == 'campaigns.Campaign_ID')

class Campaigns(db.Model):
    Campaign_ID = db.Column(db.Interger, primary_key = True)
    Campaign_Name = db.Column(db.String(255))
    Campaign_Setting = db.Column(db.String(255))
    No_of_Players = db.Column(db.Interger)
    Books_Used = db.Column(db.Interger, db.ForeignKeys == 'books.Book_ID')
